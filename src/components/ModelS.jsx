...
import ModelSImage from '../assets/ModelS.jfif'

const ModelS = () => {
  return (
    <div className='mt-[125px]'>
    <div className='w-full'>
      <img src={ModelSImage} alt="/" className='absolute w-screen h-screen object-cover md:h-screen md:w-full md:object-cover'/>
    </div>
    <div className='max-w-[1240px] mx-auto relative text-center'>
      <h1 className='pt-[110px] text-5xl font-semibold transition-all animate-fadeIn'>Model S</h1>
